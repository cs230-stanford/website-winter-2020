...
- **VERY IMPORTANT!** When you’re done using your instance, be sure to turn it off using the web interface! Otherwise your AWS account will be charged [$0.90/hr](https://aws.amazon.com/ec2/instance-types/p2/).
